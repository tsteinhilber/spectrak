...
<?php
// SET VARS
$layout = $ContactLogin->getLayout('sup-Spec');
$spePrintProcess = $layout->getValueListTwoFields("spePrintProcess");
$speSubstrate = $layout->getValueListTwoFields("speSubstrate");
$speMaxNumColors = $layout->getValueListTwoFields("speMaxNumColors");
$spePrintSurfaceOrInside = $layout->getValueListTwoFields("spePrintSurfaceOrInside");
$speProofingReqProofType = $layout->getValueListTwoFields("speProofingReq");
$speProofingReqProfileCurve = $layout->getValueListTwoFields("speProofingReqProfileCurve");
$speProofingReqScreening = $layout->getValueListTwoFields("speProofingReqScreening");
$speFinalFileType = $layout->getValueListTwoFields("speFinalFileType");
$yes_no = $layout->getValueListTwoFields("Yes/No");
...
<!-- CONTACT -->
    <tr>
      <td class="table_side_head_req" id="con_assignment_label">Printer Contact Assignment</td>
      <td class="table_row" id="con_assignment_input">
      <?php if(!$contact_error): ?>
        <span id="spryselect8">
          <select name="Spe_ConIDX" id="Spe_ConIDX">
            <?php foreach($Contacts_result->getRecords() as $Contacts_row){
              $spe_conID = $Spec_row->getField('Spe_ConIDX');
              $con_PK = $Contacts_row->getField('con_PK');
              $firstName = $Contacts_row->getField('conNameF');
              $lastName = $Contacts_row->getField('conNameL');
            ...
            ?>
              <option value="<?php echo $con_PK; ?>" <?php echo $selected ?> ><?php echo $fullName; ?></option>
            <?php } ?>
      ...
      <?php else: ?>
        <button type="button" id="btn_add_new_contact" onclick="openNewContact()">Add New Contact</button>
      <?php endif ?>
      </td>
    </tr>
...
<?php
	foreach ($spePrintProcess as $displayValue => $list_item) {
		if( fmsCompareSet($list_item, $Spec_row->getField('spePrintProcess')) ) {
...
?>
        ...
        <tr>
          ...
          <span id="spryselect2">
            <select name="speSubstrate" id="speSubstrate">
						<?php
						foreach ($speSubstrate as $displayValue => $list_item) {
							if( fmsCompareSet($list_item, $Spec_row->getField('speSubstrate')) ) {
								echo "<option value=\"{$list_item}\" selected=\"selected\">{$list_item}</option>\n";
							} else {
								echo "<option value=\"{$list_item}\">{$list_item}</option>\n";
							}
        ...
        <tr>
          ...
          <td class="table_row"><span id="spryselect3">
            <select name="speMaxNumColors" id="speMaxNumColors">
						<?php
						foreach ($speMaxNumColors as $displayValue => $list_item) {
							if( fmsCompareSet($list_item, $Spec_row->getField('speMaxNumColors')) ) {
								echo "<option value=\"{$list_item}\" selected=\"selected\">{$list_item}</option>\n";
							} else {
								echo "<option value=\"{$list_item}\">{$list_item}</option>\n";
							}
        ...
        <tr>
          ...
          <td class="table_row">
				<?php
					foreach ($spePrintSurfaceOrInside as $displayValue => $value) {
					  if( fmsCompareSet($value, $Spec_row->getField('spePrintSurfaceOrInside')) ) {
						echo "<input name=\"spePrintSurfaceOrInside\" type=\"radio\" value=\"{$value}\" checked=\"checked\">{$value}\n";
					  } else {
						echo "<input name=\"spePrintSurfaceOrInside\" type=\"radio\" value=\"{$value}\">{$value}\n";
					  }
					}
				?>
</td>
          ...
          <td class="table_row">
					<?php
						foreach ($yes_no as $displayValue => $value) {
						  if( fmsCompareSet($value, $Spec_row->getField('speCoating')) ) {
							echo "<input name=\"speCoating\" type=\"radio\" value=\"{$value}\" checked=\"checked\">{$value}\n";
						  } else {
							echo "<input name=\"speCoating\" type=\"radio\" value=\"{$value}\">{$value}\n";
						  }
						}
					?>
</td>
        ...
        <tr>
          ...
          <td class="table_row">
					<?php
						foreach ($yes_no as $displayValue => $value) {
						  if( fmsCompareSet($value, $Spec_row->getField('speWhiteInk')) ) {
							echo "<input name=\"speWhiteInk\" type=\"radio\" value=\"{$value}\" checked=\"checked\">{$value}\n";
						  } else {
							echo "<input name=\"speWhiteInk\" type=\"radio\" value=\"{$value}\">{$value}\n";
						  }
						}
					?>
</td>
        ...
        <tr>
          ...
          <td class="table_row">
					<?php
						foreach ($yes_no as $displayValue => $value) {
						  if( fmsCompareSet($value, $Spec_row->getField('speExtraStation')) ) {
							echo "<input name=\"speExtraStation\" type=\"radio\" value=\"{$value}\" checked=\"checked\">{$value}\n";
						  } else {
							echo "<input name=\"speExtraStation\" type=\"radio\" value=\"{$value}\">{$value}\n";
						  }
						}
					?>
</td>
        ...
        <tr>
          ...
          <td class="table_row">
					<?php
						foreach ($yes_no as $displayValue => $value) {
						  if( fmsCompareSet($value, $Spec_row->getField('speGradations')) ) {
							echo "<input name=\"speGradations\" type=\"radio\" value=\"{$value}\" checked=\"checked\">{$value}\n";
						  } else {
							echo "<input name=\"speGradations\" type=\"radio\" value=\"{$value}\">{$value}\n";
						  }
						}
					?>
</td>
        ...
        <tr>
          ...
          <td class="table_row">
					<?php
						foreach ($yes_no as $displayValue => $value) {
						  if( fmsCompareSet($value, $Spec_row->getField('speMinDot')) ) {
							echo "<input name=\"speMinDot\" type=\"radio\" value=\"{$value}\" checked=\"checked\">{$value}\n";
						  } else {
							echo "<input name=\"speMinDot\" type=\"radio\" value=\"{$value}\">{$value}\n";
						  }
						}
					?>
<p>What is the minimum dot? (%): <input name="speMinDotPerc" type="text" value="<?php echo $Spec_row->getField('speMinDotPerc'); ?>" id="speMinDotPerc" class="input_50perc"></p>
		...
		<tr>
			...
			<?php
				foreach ($yes_no as $displayValue => $value) {
				  if( fmsCompareSet($value, $Spec_row->getField('speDocumentRasterEffects')) ) {
					echo "<input name=\"speDocumentRasterEffects\" type=\"radio\" value=\"{$value}\" checked=\"checked\">{$value}\n";
				  } else {
					echo "<input name=\"speDocumentRasterEffects\" type=\"radio\" value=\"{$value}\">{$value}\n";
				  }
				}
			?>
</td>
		...
		<tr>
			...
			<?php
				foreach ($yes_no as $displayValue => $value) {
				  if( fmsCompareSet($value, $Spec_row->getField('speAbobeIllustratorTransparencyEffects')) ) {
					echo "<input name=\"speAbobeIllustratorTransparencyEffects\" type=\"radio\" value=\"{$value}\" checked=\"checked\">{$value}\n";
				  } else {
					echo "<input name=\"speAbobeIllustratorTransparencyEffects\" type=\"radio\" value=\"{$value}\">{$value}\n";
				  }
				}
			?>
</td>
        ...
        <tr>
          ...
          <td class="table_row">
					<?php
						foreach ($yes_no as $displayValue => $value) {
						  if( fmsCompareSet($value, $Spec_row->getField('speRichBlackTreatment')) ) {
							echo "<input name=\"speRichBlackTreatment\" type=\"radio\" value=\"{$value}\" checked=\"checked\">{$value}\n";
						  } else {
							echo "<input name=\"speRichBlackTreatment\" type=\"radio\" value=\"{$value}\">{$value}\n";
						  }
						}
					?>
</td>
        ...
        <tr>
          ...
          <td class="table_row">
					<?php
						foreach ($yes_no as $displayValue => $value) {
						  if( fmsCompareSet($value, $Spec_row->getField('speScalesMarks')) ) {
							echo "<input name=\"speScalesMarks\" type=\"radio\" value=\"{$value}\" checked=\"checked\">{$value}\n";
						  } else {
							echo "<input name=\"speScalesMarks\" type=\"radio\" value=\"{$value}\">{$value}\n";
						  }
						}
					?>
        ...
        <tr>
          ...
          <select name="speProofingReqProofType" id="speProofingReqProofType">
						<?php
						foreach ($speProofingReqProofType as $displayValue => $list_item) {
							if( fmsCompareSet($list_item, $Spec_row->getField('speProofingReqProofType')) ) {
								echo "<option value=\"{$list_item}\" selected=\"selected\">{$list_item}</option>\n";
							} else {
								echo "<option value=\"{$list_item}\">{$list_item}</option>\n";
							}
        ...
        <tr>
          ...
          <select name="speProofingReqProfileCurve" id="speProofingReqProfileCurve">
						<?php
						foreach ($speProofingReqProfileCurve as $displayValue => $list_item) {
							if( fmsCompareSet($list_item, $Spec_row->getField('speProofingReqProfileCurve')) ) {
								echo "<option value=\"{$list_item}\" selected=\"selected\">{$list_item}</option>\n";
							} else {
								echo "<option value=\"{$list_item}\">{$list_item}</option>\n";
							}
				...
				<p id="speProofingReqProfileCurveInstructions">
					If yes, please include instructions <input name="speProofingReqProfileCurveInstructions" type="text" value="<?php echo $Spec_row->getField('speProofingReqProfileCurve'); ?>" id="speProofingReqProfileCurveInstructions" class="input_40perc">
				</p>
			</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <select name="speProofingReqScreening" id="speProofingReqScreening">
						<?php
						foreach ($speProofingReqScreening as $displayValue => $list_item) {
							if( fmsCompareSet($list_item, $Spec_row->getField('speProofingReqScreening')) ) {
								echo "<option value=\"{$list_item}\" selected=\"selected\">{$list_item}</option>\n";
							} else {
								echo "<option value=\"{$list_item}\">{$list_item}</option>\n";
							}
			    	...
			    	If yes, please include instructions <input name="speProofingReqScreeningInstructions" type="text" value="<?php echo $Spec_row->getField('speProofingReqScreeningInstructions'); ?>" id="speProofingReqScreeningInstructions" class="input_40perc">
					</p>
					</td>
        </tr>
        <tr>
          ...
          <td class="table_row">
					<?php
						foreach ($yes_no as $displayValue => $value) {
						  if( fmsCompareSet($value, $Spec_row->getField('speStepping')) ) {
							echo "<input name=\"speStepping\" type=\"radio\" value=\"{$value}\" checked=\"checked\">{$value}\n";
						  } else {
							echo "<input name=\"speStepping\" type=\"radio\" value=\"{$value}\">{$value}\n";
						  }
						}
					?>
					<p>Please include instructions: <input name="speSteppingInstructions" type="text" value="<?php echo $Spec_row->getField('speSteppingInstructions'); ?>" id="speSteppingInstructions" class="input_50perc"></p>
					</td>
        </tr>
        <tr>
          ...
          <select name="speFinalFileType" id="speFinalFileType">
						<?php
						foreach ($speFinalFileType as $displayValue => $list_item) {
							if( fmsCompareSet($list_item, $Spec_row->getField('speFinalFileType')) ) {
								echo "<option value=\"{$list_item}\" selected=\"selected\">{$list_item}</option>\n";
							} else {
								echo "<option value=\"{$list_item}\">{$list_item}</option>\n";
							}
        ...
        <tr>
          ...
          <td class="table_row">
					<?php
						foreach ($yes_no as $displayValue => $value) {
						  if( fmsCompareSet($value, $Spec_row->getField('speFtp')) ) {
							echo "<input name=\"speFtp\" type=\"radio\" value=\"{$value}\" checked=\"checked\">{$value}\n";
						  } else {
							echo "<input name=\"speFtp\" type=\"radio\" value=\"{$value}\">{$value}\n";
						  }
						}
					?>
					</td>
