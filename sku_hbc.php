...
<!-- SKU INFO TABLE -->
    ...
    <table id="SKU_info" class="table" width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td class="table_side_head"><p>Available Trademarks / <br />Brand Names</p></td>
      ...
      <tr>
        <td class="table_side_head">&quot;Compare To&quot; Statement</td>
        <td class="table_row"><span id="sprytextfield5">
          <input name="pdkCompareToStatement" type="text" value="<?php echo $PDK_row->getField('pdkCompareToStatement'); ?>" id="pdkCompareToStatement"></span>
		</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="table_row"><span id="sprytextfield80">
          <input name="pdkProductUseStorage" type="text" value="<?php echo $PDK_row->getField('pdkProductUseStorage'); ?>" id="pdkProductUseStorage">
          </span></td>
      </tr>
      <tr>
...
<!-- SKU DATE CODING -->
      <table id="SKU DATE CODING" class="table" width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td class="table_row_form"><span id="sprytextfield8">
        ...
        <tr>
          ...
          <td class="table_row_form"><span id="sprytextfield9">
  ...
  <table id="SKU IMAGERY SUBMISSION" class="table" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td class="table_side_head_wrap"><p>Printed Sample – Representative printed, packaged product (including lid/cap options, etc.)<br />
        <br>
        <strong>Galileo Global Branding Group, Inc. would like to investigate any opportunities for unique and innovative packaging.&nbsp; Please provide any alternative, existing package options that could be utilized<br />
          – </strong><strong>e.g.,&nbsp; optional label substrates, alternate bottle shapes.&nbsp; </strong></p></td>
...
var sprytextfield80 = new Spry.Widget.ValidationTextField("sprytextfield80");
var spryselect4 = new Spry.Widget.ValidationSelect("spryselect4", {isRequired:false});
var spryselect8 = new Spry.Widget.ValidationSelect("spryselect8", {isRequired:false});
