...
<? 
$_SESSION['cmp_ID'] = $Contact_row->getField('con_FK_cmp');
$_SESSION['conName'] = $Contact_row->getField('conNameFull');
$_SESSION['supplierName'] = $Contact_row->getField('Sup::cmpCompany'); 
...
<!-- Dev Test
  ...
  <h4>cmp_ID: <? echo $_SESSION['cmp_ID'] ?></h4>
  <h4>conName: <? echo $_SESSION['conName'] ?></h4>
  <h4>supplierName: <? echo $_SESSION['supplierName'] ?></h4>
  <h4>con_FK_cmp: <? echo $Contact_row->getField('con_FK_cmp'); ?></h4>
