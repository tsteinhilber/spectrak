...
<title>SpecTrak | <?php echo $Supplier_row->getField('cmpCompany'); ?>: New Contact</title>
...
<ul id="actions" class="MenuBarVertical">
  ...
  <li><a href="supplier.php">Cancel</a></li>
</ul>
<!-- end #sidebar1 --></div>
  ...
  <!-- NEW CONTACT TABLE -->
  <table id="new_contact_table" class="table" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
    ...
    ?>
              	<option value="<?php echo $Supplier__SupAddress_portal->getField('SupAddress::add_PK'); ?>"><?php echo $Supplier__SupAddress_portal->getField('SupAddress::addAddress'); ?> <?php echo $Supplier__SupAddress_portal->getField('SupAddress::addCityStateZip'); ?></option>
  ...
  <div class="">
    <input type="button" value="Save" id="save_button" onclick="validateOnSubmit();" class='grayButton'>
  </div>
