...
<?php
$edit_contact_edit = $ContactLogin->newEditCommand('sup-conLogin',$_REQUEST['contact']);
$edit_contact_fields = array('conSubscriberAgreement'=>'1','conSubscriberAgreementDate'=>$today,);
