...
{ 
	...
	//echo "<b>new_upc_fk_die:</b> " . $new_upc_fk_die . "<br><br>";
...
<title>Update Dieline Assignments</title>
...
<form id="returnInfo" name="returnInfo" method="post" action="<?php echo $redirect; ?>">
  ...
  <input id="assigned_item" name="assigned_item" type="hidden" value="<?php echo $die_pk ?>">
</form>
</body>
</html>
