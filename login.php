...
// check for repeat login
$referrer = $_SERVER['HTTP_REFERER'];
if($referrer == "login.php" && $loginError == ""){
	fmsRedirect('index.php');
}
...
<div id="footerLogin">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="25" valign="MIDDLE" align="LEFT">&copy;  Daymon Worldwide Design, Inc.</td>
      </tr>
    </table>
</div>
...
<!--
var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextfield1", "email", {maxChars:100});
